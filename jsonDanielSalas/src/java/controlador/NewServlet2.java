        ...
        if (menu.equals("players")) {
            switch (accion) {
                ...
                case "actualizar":
                    ...
                    //JSONObject ObjetoJson = new JSONObject(jsonjuego);  
//                      JSONObject jsonobj = jsonArray.getJSONObject(i);
                    //JSONObject jsonArray = ObjetoJson.getJSONArray("jugadores");
                    String dorsal = "dorsal";
                    String mensaje2 = playerSafe.actualizar(arrayplay);
                    salida.print(mensaje2);
                    break;
            }
        }
